<?php
// reportes_admin.php
// Versión para Administrador

require __DIR__ . '/../php/conexion.php';

// Verificación de sesión (opcional, pero recomendada si tienes login)
session_start();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $zona !== '') {
    ...
    if ($stmt) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            error_log('Error execute reportes_admin.php: ' . mysqli_error($conexion));
        }
    } else {
        error_log('Error prepare reportes_admin.php: ' . mysqli_error($conexion));
    }
}
?>
<!DOCTYPE html>
...
<head>
    <meta charset="UTF-8">
    <title>Reportes por zona - Administrador</title>
    ...
    <div class="app-shell">
        <header class="app-header">
            ...
            <div class="app-header-right">
                ...
                <a href="../home.php" class="btn-ghost">
