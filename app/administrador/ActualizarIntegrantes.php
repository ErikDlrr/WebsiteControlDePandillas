<?php
// ActualizarIntegrantes.php
// Formulario para actualizar datos de un integrante existente
...
<head>
    ...
    <title>Actualizar Integrantes - Criminal Nexus</title>
...
<div class="app-shell">
    <header class="app-header">
        <div class="app-header-left">
            ...
            <p class="app-subtitle">Actualizar datos de integrantes.</p>
        </div>
        <div class="app-header-right">
            <span class="badge">
                <i class="fa-solid fa-user-gear"></i>&nbsp;Integrantes
            </span>
    ...
    <main class="app-main">
        <section class="module-card">
            ...
            <p class="module-description">
                Indica el ID del integrante y rellena solo los campos que quieras actualizar.
            </p>

            <!-- Sigue apuntando a registrointegrantes2.php -->
            <form class="login" action="registrointegrantes2.php" method="post">

                <div class="field">
                    <label for="id_Integrante">ID del integrante (obligatorio)</label>
                    <div class="field-inner">
                        <i class="fa-solid fa-hashtag"></i>
                        <input type="number" name="id_Integrante" id="id_Integrante" required>
                    </div>
                </div>
                ...
                <div class="module-grid">
                    ...
                    <div class="field">
                        ...
                        <div class="field-inner">
                            ...
                            <select name="id_Pandilla" id="id_Pandilla">
