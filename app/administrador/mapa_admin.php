...
<head>
    <meta charset="UTF-8">
    <title>Criminal Nexus - Mapa Administrador</title>
        ...
        <main class="app-main">
            <section class="consultor-card">
                ...
                <div class="consultor-links">
                    <a href="ConsultarPandillas.html" class="link-pill">
                        <span class="link-pill-label">Ver listado detallado</span>
                    </a>
                    <a href="reportes_admin.php" class="link-pill">
                        <span class="link-pill-label">Ir a Reportes</span>
                    </a>
                </div>
            </section>
        </main>
